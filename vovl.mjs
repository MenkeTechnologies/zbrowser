...
console.log('terminal overlay content script loaded:', await ev('!!document.getElementById("terminalPane")'));
...
console.log('overlay active after Ctrl+`:', await ev('document.getElementById("terminalPane")?.classList.contains("active")'));
console.log('xterm rendered:', await ev('!!document.querySelector("#terminalPane .xterm")'));
console.log('zb_term_open flag set:', await ev('"(check storage separately)"'));
